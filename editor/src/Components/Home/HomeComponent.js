      ...
      <main className={styles.heroSection}>
        <div className={styles.heroLeft}>
          ...
          <div className={styles.ctaRow}>
            <Link to={`/${createId()}`}>
              <Button size="large" shape="round" className={styles.ctaPrimary}>
                Start new session
              </Button>
            </Link>

            <a href={GITHUB_URL} target="_blank" rel="noreferrer" aria-label="Open CodeCrew on GitHub">
              <Button size="large" shape="round" className={styles.ctaGhost} icon={<GithubIcon className={styles.githubIcon} />}>
                GitHub
              </Button>
            </a>
          </div>
      ...
      <section className={styles.infoSection}>
        <div className={styles.infoCard}>
          ...
          <ul className={styles.bullets}>
            ...
            <li>Run code on custom test cases (C++, Java, Python 3)</li>
